  ...
  const whyCard = [
    {
      ...
      description:
        'There is always a branch near you with our <span class="red">3,000 branches</span> nationwide',
      img: "https://mlhuillier.com/img/revamp/filipino-philippines.svg",
    },
    {
      title: "For over 40 years",
      description:
        'A trusted name  <span class="red"> known by every Filipino </span> for all types of financial services',
      img: "https://mlhuillier.com/img/revamp/icons/ml-diamond.svg",
    },
    {
      title: "In your pocket",
      description:
        'With  <span class="red"> MCash</span>, you have access to all our services anytime, anywhere',
    ...
    <main>
      ...
      <div className="gradient-section">
        ...
        <Container>
          <div className="col-md-12 main-page-card-container">
            <Link href={"/loans?type=car"} className="col-md-3">
            ...
            <Link href={"/loans?type=home"} className="col-md-3">
              <div className="main-page-card-wrapper">
                <div className="main-page-card">
                  <div className="main-page-card-details">
            ...
            <Link href={"/loans?type=salary"} className="col-md-3">
              <div className="main-page-card-wrapper">
                <div className="main-page-card">
                  <div className="main-page-card-details">
                    <p className="red readable medium">Salary Loan</p>
                    <p>Get salary loan approvals in 1 minute!</p>
                  </div>
                  <Image
                    className="check"
                    src="https://mlhuillier.com/img/revamp/individual-personal-loan.svg"
                    alt="MLhuillier logo"
                    width={100}
                    height={100}
                  />
      ...
      <Container className="why-main">
        <div className="center-why-main">
          <span className="banner-text-main medium big">
            Why do <span className="red">25m+ Filipinos</span> love M.
            Lhuillier?{" "}
          </span>{" "}
          <br />
        </div>
        ...
        <div className="row text-center">
          {whyCard.map((item) => (
            <div
              key={item.title}
              className="col-md-4 mb-5 mb-md-0 order-md-1 order-2"
            >
              <div className="icon-wrapper mb-4">
                <Image src={item.img} alt="Icon" width={120} height={170} />
              </div>
              <h6>{item.title}</h6>
